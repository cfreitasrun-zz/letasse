	...
	if( !class_exists( 'Side_Menu_Class' ) ) {
		...
		{				
			...
			function display() {
				...
				if (count($arrresult) > 0 && count($arrresult) < 6) {
			...
			function row_meta( $meta, $plugin_file ){
				...
				return $meta;
				$meta[] = '<a href="https://wordpress.org/support/plugin/float-menu" target="_blank">Support </a> | <a href="https://wow-estore.com/item/float-menu-pro/" target="_blank">Pro version</a>';
				return $meta;
			}
